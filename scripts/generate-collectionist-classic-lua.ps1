...
$mountLines.Add("})")
Write-LuaFile "Modules\Mounts\Data\Classic.lua" $mountLines
...
$petLines.Add("})")
Write-LuaFile "Modules\Pets\Data\Classic.lua" $petLines
...
$toyLines.Add("})")
Write-LuaFile "Modules\Toys\Data\Classic.lua" $toyLines
...
$decorLines.Add("})")
Write-LuaFile "Modules\Decorations\Data\Classic.lua" $decorLines
...
$achievementGroups = @{
    ...
    "14801" = @("features", "alterac", "Alterac Valley")
    "14802" = @("features", "arathi", "Arathi Basin")
    "14804" = @("features", "warsong", "Warsong Gulch")
    "14808" = @("features", "dungeons", "Classic Dungeons")
    "14821" = @("features", "raid", "Classic Raids")
    "14861" = @("quests", "metas", "Eastern Kingdoms")
    "14864" = @("features", "reputation", "Classic Reputation")
    "15081" = @("quests", "metas", "Kalimdor")
}
$categoryOrder = @("14777", "14778", "14801", "14802", "14804", "14808", "14821", "14861", "14864", "15081")
...
$achievementLines.Add("})")
Write-LuaFile "Modules\Achievements\Data\Classic.lua" $achievementLines
...
$recipeLines.Add("})")
Write-LuaFile "Modules\Recipes\Data\Classic.lua" $recipeLines
...
$rareLines.Add("end")
Write-LuaFile "Modules\Rares\Data\Classic.lua" $rareLines
...
$treasureLines.Add("end")
Write-LuaFile "Modules\Treasures\Data\Classic.lua" $treasureLines

Write-Host "Generated Classic Lua data files"
