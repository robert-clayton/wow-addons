...
MC.DecoProfOrder = { 171, 164, 333, 202, 773, 755, 165, 197 }
MC.DecoProfLabels = {
...
MC.DecorationData = {
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14559, itemID = 262356, name = "Haranir Preserving Agents", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
            { decorID = 1247, itemID = 253506, name = "Rootbound Vat", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
            { decorID = 11138, itemID = 256356, name = "Sunsmoke Censer", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
            { decorID = 14558, itemID = 262355, name = "Entropic Illuminant", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
            { decorID = 14557, itemID = 262354, name = "Riftstone", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
            { decorID = 11501, itemID = 257420, name = "Silvermoon Spire Fountain", source = "crafted", sourceInfo = "Alchemy craft", skillLine = 171 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14581, itemID = 262451, name = "Gilded Silvermoon Anvil", source = "crafted", sourceInfo = "Blacksmithing craft", skillLine = 164 },
            { decorID = 14587, itemID = 262457, name = "Gilded Silvermoon Hanger", source = "crafted", sourceInfo = "Blacksmithing craft", skillLine = 164 },
            { decorID = 14590, itemID = 262460, name = "Ren'dorei Anvil", source = "crafted", sourceInfo = "Blacksmithing craft", skillLine = 164 },
            { decorID = 14582, itemID = 262452, name = "Masterwork Crafting Hammer", source = "crafted", sourceInfo = "Blacksmithing craft", skillLine = 164 },
            { decorID = 14586, itemID = 262456, name = "Ornamental Silvermoon Hanger", source = "crafted", sourceInfo = "Blacksmithing craft", skillLine = 164 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14580, itemID = 262450, name = "Ensorcelled Broom", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            { decorID = 14585, itemID = 262455, name = "Font of Gleaming Water", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            { decorID = 14589, itemID = 262459, name = "Animated Sin'dorei Hammer", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            { decorID = 14588, itemID = 262458, name = "Animated Sin'dorei Pick", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            ...
            { decorID = 2460, itemID = 246693, name = "Self-Pouring Thalassian Sunwine", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            ...
            { decorID = 14616, itemID = 262590, name = "Rootflame Campfire", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
            { decorID = 14598, itemID = 262468, name = "Ren'dorei Postal Repository", source = "crafted", sourceInfo = "Enchanting craft", skillLine = 333 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14643, itemID = 262618, name = "Ren'dorei Void Projector", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 14835, itemID = 263049, name = "Ren'dorei Lightpost", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 2301, itemID = 246460, name = "Ambient Aethercharged Crystal", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 14595, itemID = 262465, name = "Ren'dorei Stargazer", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 14730, itemID = 262789, name = "Small Telogrus Lamp", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 14642, itemID = 262617, name = "Ren'dorei Crafting Framework", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
            { decorID = 14627, itemID = 262602, name = "Ren'dorei Warp Orb", source = "crafted", sourceInfo = "Engineering craft", skillLine = 202 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14637, itemID = 262612, name = "Sturdy Ren'dorei Cask", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14594, itemID = 262464, name = "Floating Void-Touched Tome", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14620, itemID = 262594, name = "Homely Sin'dorei Shelf", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            -- Lively Songwriter's Quill omitted here (listed under treasure drops with decorID 14641)
            { decorID = 14623, itemID = 262598, name = "Opened Sin'dorei Scroll", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14622, itemID = 262597, name = "Gilded Eversong Book", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14640, itemID = 262615, name = "Sin'dorei Phoenix Quill", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14621, itemID = 262595, name = "Homely Wall Shelves", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            { decorID = 14626, itemID = 262601, name = "Wild Hanging Scroll", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
            ...
            { decorID = 14731, itemID = 262790, name = "Restful Bronze Bench", source = "crafted", sourceInfo = "Inscription craft", skillLine = 773 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14599, itemID = 262469, name = "Brilliant Phoenix Harp", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
            { decorID = 14591, itemID = 262461, name = "Tenebrous Ren'dorei Armillary", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
            { decorID = 14601, itemID = 262471, name = "Bejeweled Sin'dorei Lyre", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
            { decorID = 5133, itemID = 248965, name = "Resplendent Highborne Statue", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
            { decorID = 14638, itemID = 262613, name = "Replica Haranir Mural", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
            { decorID = 14584, itemID = 262454, name = "Shining Sin'dorei Hourglass", source = "crafted", sourceInfo = "Jewelcrafting craft", skillLine = 755 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14579, itemID = 262449, name = "Embossed Sin'dorei Fur Rug", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
            { decorID = 1142, itemID = 253457, name = "Leather-Bound Haranir Wall Shelf", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
            { decorID = 17515, itemID = 265791, name = "Haranir Canopy Bed", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
            { decorID = 14625, itemID = 262600, name = "Stitched Haranir Rug", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
            { decorID = 1157, itemID = 243090, name = "Sturdy Haranir Chair", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
            { decorID = 15479, itemID = 264244, name = "Plush Haranir Leather Pillow", source = "crafted", sourceInfo = "Leatherworking craft", skillLine = 165 },
        },
    },
    ...
    -------------------------------------------------------------------------
    {
        source = "crafted",
        decorations = {
            { decorID = 14624, itemID = 262599, name = "Silvermoon Curtains", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
            { decorID = 14555, itemID = 262352, name = "Lush Telogrus Carpet", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
            { decorID = 14617, itemID = 262591, name = "Luxurious Silvermoon Lounge Cushion", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
            { decorID = 14618, itemID = 262592, name = "Plush Silvermoon Bed", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
            { decorID = 14619, itemID = 262593, name = "Chic Silvermoon Pillow", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
            { decorID = 14636, itemID = 262611, name = "Voidstrider Saddlebag", source = "crafted", sourceInfo = "Tailoring craft", skillLine = 197 },
        },
    },
