...
Retail only (Interface 120005). TomTom is optional but recommended. Without it, waypoints fall back to the Blizzard map pin, which works but isn't as nice.

If a collectible is missing or has the wrong source, open an issue with the item ID and I'll add it.
