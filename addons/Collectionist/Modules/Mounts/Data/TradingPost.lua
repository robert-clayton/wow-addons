...
MC.RegisterContent("df", "mounts", {
    { source = "tradingpost", mounts = {
        { mountID = 125, name = "Riding Turtle", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.7", zone = "Dornogal", itemID = 23720 },
        { mountID = 371, name = "Blazing Hippogryph", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.6", zone = "Dornogal", itemID = 54069 },
        ...
        { mountID = 382, name = "X-53 Touring Rocket", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.5", zone = "Dornogal", itemID = 54860 },
        ...
        { mountID = 1468, name = "Amber Skitterfly", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.6", zone = "Dornogal", itemID = 192766 },
        { mountID = 1573, name = "Magenta Cloud Serpent", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.0.5", zone = "Dornogal", itemID = 189978 },
        ...
        { mountID = 1575, name = "Quawks", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.1.0", zone = "Dornogal", itemID = 190169 },
        { mountID = 1577, name = "Ash'adar, Harbinger of Dawn", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.0.5", zone = "Dornogal", itemID = 190231 },
        ...
        { mountID = 1586, name = "Armored Golden Pterrordax", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.0", zone = "Dornogal", itemID = 190767 },
        { mountID = 1742, name = "Felcrystal Scorpion", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.1.5", zone = "Dornogal", itemID = 206027 },
        { mountID = 1784, name = "Royal Swarmer", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.1.0", zone = "Dornogal", itemID = 206976 },
        { mountID = 1785, name = "Ancestral Clefthoof", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.1.5", zone = "Dornogal", itemID = 207821 },
        ...
        { mountID = 1841, name = "Crimson Glimmerfur", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.0", zone = "Dornogal", itemID = 210919 },
        { mountID = 1942, name = "Jeweled Copper Scarab", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.0", zone = "Dornogal", itemID = 211074 },
        { mountID = 1956, name = "Fur-endship Fox", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.5", zone = "Dornogal", itemID = 212227 },
        { mountID = 2035, name = "Majestic Azure Peafowl", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.5", zone = "Dornogal", itemID = 212630 },
        { mountID = 2039, name = "Savage Blue Battle Turtle", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.6", zone = "Dornogal", itemID = 212920 },
        { mountID = 2152, name = "Pearlescent Goblin Wave Shredder", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.7", zone = "Dornogal", itemID = 221814 },
        { mountID = 2189, name = "Underlight Corrupted Behemoth", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r10.2.7", zone = "Dornogal", itemID = 223285 },
    } },
})
...
MC.RegisterContent("tww", "mounts", {
    { source = "tradingpost", mounts = {
        { mountID = 1550, name = "Depthstalker", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.2", zone = "Dornogal", itemID = 187674 },
        ...
        { mountID = 1958, name = "Twilight Sky Prowler", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.5", zone = "Dornogal", itemID = 212229 },
        ...
        { mountID = 2198, name = "Kor'kron Warsaber", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.0", zone = "Dornogal", itemID = 223449 },
        { mountID = 2201, name = "Sentinel War Wolf", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.0", zone = "Dornogal", itemID = 223469 },
        { mountID = 2238, name = "Plunderlord's Golden Crocolisk", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.2", zone = "Dornogal", itemID = 226040 },
        { mountID = 2239, name = "Keg Leg's Radiant Crocolisk", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.2", zone = "Dornogal", itemID = 226041 },
        { mountID = 2249, name = "Hand of Reshkigaal", source = "tradingpost", sourceInfo = "|cFFFFD200Trading Post|r|n|cFFFFD200First offered: |r11.0.2", zone = "Dornogal", itemID = 226506 },
