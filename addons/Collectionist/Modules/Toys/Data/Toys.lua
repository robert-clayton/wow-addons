    ...
    -- Renown vendor toys (Voidlight Marl)
    {
        ...
        toys = {
            ...
            { itemID = 263244, name = "Enigmatic Fountain", source = "renown",
              sourceInfo = "Void Researcher Anomander",
    ...
    -- Achievement toys (zone treasure meta-achievements + hidden FoS)
    {
        ...
        toys = {
            { itemID = 268717, name = "Pango Plating", source = "achievement",
              ...
              achievementID = 62125, score = T.short, waypoint = { 2437, 0.3220, 0.2230, "Pango Plating" } },
    ...
    -- Quest toys (campaign rewards)
    {
        ...
        toys = {
            { itemID = 253629, name = "Personal Key to the Arcantina", source = "quest",
              ...
              zone = "Silvermoon City", score = T.medium, waypoint = { 2393, 0.4060, 0.6610, "Personal Key to the Arcantina" } },
            { itemID = 264413, name = "Dominating Victory", source = "quest",
              sourceInfo = "Quest: Nulling Nullaeus (Torment's Rise nemesis delve)", zone = "Silvermoon City", waypoint = { 2393, 0.5250, 0.7830, "Dominating Victory" } },
            { itemID = 263871, name = "Holy Pet Leash", source = "quest",
              sourceInfo = "Quest: Pet Wranglin' (capture a wild pet in any Midnight zone)",
              zone = "Silvermoon City", waypoint = { 2393, 0.4180, 0.7640, "Holy Pet Leash" } },
            { itemID = 257736, name = "Lightcalled Hearthstone", source = "quest",
              sourceInfo = "March on Quel'Danas storyline quest reward",
              zone = "Isle of Quel'Danas", waypoint = { 2424, 0.5260, 0.9020, "Lightcalled Hearthstone" } },
            { itemID = 267456, name = "Lil' Scoots' Pillow", source = "quest",
              sourceInfo = "Quest: Scoot Along Now (return Lil' Scoots to Ranger Telenus)",
              zone = "Eversong Woods", waypoint = { 2393, 0.4480, 0.6040, "Lil' Scoots' Pillow" } },
            { itemID = 263198, name = "Valdekar's Special", source = "quest",
              sourceInfo = "Quest: Lost in Light",
              zone = "Eversong Woods", waypoint = { 2395, 0.4880, 0.7670, "Valdekar's Special" } },
        },
    },
    ...
    -- Zone treasure toys (single chest / interaction loot, not meta-rewards)
    {
        ...
        toys = {
            { itemID = 258963, name = "Shroom Jumper's Parachute", source = "treasure",
              ...
              zone = "Harandar",
              dropInfo = { mob = "Failed Shroom Jumper's Satchel", zone = "Harandar" }, waypoint = { 2413, 0.7170, 0.3100, "Shroom Jumper's Parachute" } },
            { itemID = 259084, name = "Gift of the Cycle", source = "treasure",
              sourceInfo = "Bottom of the pool in The Den, Harandar",
              zone = "Harandar", waypoint = { 2576, 0.4730, 0.5050, "Gift of the Cycle" } },
            { itemID = 267139, name = "Hungry Black Hole", source = "treasure",
              sourceInfo = "Bloody Sack, Obscurion Citadel (Voidstorm)",
              zone = "Voidstorm",
              dropInfo = { mob = "Bloody Sack", zone = "Voidstorm" }, waypoint = { 2405, 0.6440, 0.7550, "Hungry Black Hole" } },
            { itemID = 250319, name = "Researcher's Shadowgraft", source = "treasure",
              ...
              zone = "Voidstorm",
              dropInfo = { mob = "Forgotten Researcher's Cache", zone = "Voidstorm" }, waypoint = { 2527, 0.2370, 0.8310, "Researcher's Shadowgraft" } },
        },
    },
    ...
    -- Drop toys (transformations — chest / rare drops)
    {
        ...
        toys = {
            { itemID = 252265, name = "Hexed Potatoad Mucus", source = "drop",
              ...
              zone = "Zul'Aman",
              dropInfo = { mob = "Sturdy Chest", zone = "Atal'Aman delve", rate = "Guaranteed (one-time)" }, score = T.short, waypoint = { 2535, 0.4830, 0.5050, "Hexed Potatoad Mucus" } },
            ...
            { itemID = 264805, name = "Brann-O-Vision 3000", source = "drop",
              ...
              dropInfo = { mob = "Sturdy Chest", zone = "Delves" }, waypoint = { 2505, 0.3980, 0.2660, "Brann-O-Vision 3000" } },
        },
    },
    ...
    -- Dungeon / Raid drops
    {
        ...
        toys = {
            { itemID = 268728, name = "Saptor Salve", source = "dungeon",
              ...
              dropInfo = { mob = "Ziekket", zone = "The Binding Vale", boss = true }, score = T.epic, waypoint = { 2413, 0.2720, 0.7800, "Saptor Salve" } },
        },
    },
    {
        source = "raid",
        toys = {
            { itemID = 264672, name = "Cosmic Ritual Stone", source = "raid",
              ...
              dropInfo = { mob = "Fallen-King Salhadaar", zone = "The Voidspire", boss = true }, waypoint = { 2405, 0.4540, 0.6400, "Cosmic Ritual Stone" } },
        },
    },
    ...
    -- Delves — Voidlight Marl)
    {
        ...
        toys = {
            ...
            { itemID = 265100, name = "Corewarden's Hearthstone", source = "vendor",
              sourceInfo = "Naleidea Rivergleam - 10 Voidlight Marl",
            ...
            { itemID = 249468, name = "Twilight's Blade Top Secret Strategy Training Guide", source = "vendor",
              ...
              cost = { currency = { MC.CURRENCY.TwilightsBladeInsignia, 30 } }, score = T.legendary, unavailable = true, waypoint = { 241, 0.4980, 0.8130, "Twilight's Blade Top Secret Strategy Training Guide" } },
        },
    },
    ...
    -- World event toys (seasonal events with Midnight-era additions)
    {
        ...
        toys = {
            { itemID = 239018, name = "Winner's Podium", source = "worldevent",
              sourceInfo = "Dastardly Duos weekly quest reward (returns for Decor Duel in 12.0.5)", waypoint = { { 84, 0.6720, 0.8100, "Winner's Podium" }, { 2393, 0.3160, 0.7660, "Winner's Podium" } } },
            { itemID = 272287, name = "Nap Mat", source = "worldevent",
              sourceInfo = "Children's Week 2026 vendor reward (Well-loved Figurine token)", waypoint = { { 84, 0.5800, 0.5680, "Nap Mat" }, { 85, 0.5800, 0.5680, "Nap Mat" }, { 2339, 0.5580, 0.2640, "Nap Mat" } } },
        },
    },
})
