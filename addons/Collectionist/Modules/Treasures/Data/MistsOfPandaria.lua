...
MC.RegisterContent("mop", "treasures", {
    ...
    { source = "pandaria", achievementID = 7997, criteriaCount = 18,
      ...
      zoneMapID = MC.MAP.Pandaria, zone = "Pandaria" },
    { source = "timeless", achievementID = 8726, criteriaCount = 3,
    ...
    { source = "timeless", achievementID = 8727, criteriaCount = 3,
      ...
      zoneMapID = MC.MAP.TimelessIsle, zone = "Timeless Isle" },
    { source = "timeless", achievementID = 8729, criteriaCount = 42,
      ...
      zoneMapID = MC.MAP.TimelessIsle, zone = "Timeless Isle" },
    { source = "timeless", achievementID = 8784, criteriaCount = 4,
