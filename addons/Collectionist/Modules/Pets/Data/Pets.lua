...
MC.RegisterContent("midnight", "pets", {
    ...
    -- Required for the Midnight Safari achievement (ID 61091).
    {
        ...
        pets = {
            ...
            { speciesID = 4912, npcID = 254885, name = "Silvermoon Broom",      petType = 6,  source = "wild", sourceInfo = "Silvermoon City - rare (2-3+ hr respawn)", canBattle = false, waypoint = LOC.SilvermoonBroom, zone = "Silvermoon City", score = T.long },
            ...
            { speciesID = 4876, npcID = 249816, name = "Mud Potadpole",         petType = 9,  source = "wild", sourceInfo = "Harandar - rare (3+ hr respawn)",        canBattle = false, waypoint = LOC.MudPotadpole,     zone = "Harandar", score = T.long },
            ...
            { speciesID = 4892, npcID = 250680, name = "Riftblade Familiar",    petType = 6,  source = "wild", sourceInfo = "Voidstorm - rare, near Obscurian Citadel", canBattle = false, waypoint = LOC.RiftbladeFamiliar, zone = "Voidstorm", score = T.medium },
            ...
            { speciesID = 4884, npcID = 249825, name = "Pangolil",              petType = 8,  source = "wild", sourceInfo = "Zul'Aman - bridge patrol, rare (4-8+ hr respawn)", canBattle = false, waypoint = LOC.Pangolil, zone = "Zul'Aman", score = T.long },
            ...
            { speciesID = 4891, npcID = 250573, name = "Wrathful Wyrm",         petType = 6,  source = "wild", sourceInfo = "Isle of Quel'Danas - rare (3+ hr respawn)", canBattle = false, waypoint = LOC.WrathfulWyrm, zone = "Isle of Quel'Danas", score = T.long },
        },
    },
    ...
    -- Drop Pets
    {
        ...
        pets = {
            { speciesID = 4985, npcID = 258281, name = "Princess Bloodshed",    petType = 8,  source = "drop", sourceInfo = "Dame Bloodshed (rare), Eversong Woods",   canBattle = true,  waypoint = LOC.DameBloodshed, zone = "Eversong Woods",
              dropInfo = { mob = "Dame Bloodshed", npcID = 255348, zone = "Eversong Woods" }, score = T.epic },
    ...
    -- Quest Pets
    {
        ...
        pets = {
            ...
            { speciesID = 4942, npcID = 255689, name = "Distorted Memory",          petType = 7, source = "quest", sourceInfo = "Chain: The Listener — The Empty Cradle (Storyline 5929)",          canBattle = false, waypoint = LOC.ZurasharKassameh, zone = "Harandar", score = T.medium },
            ...
            { speciesID = 4816, npcID = 245043, name = "Hawkstrider Hatchling",     petType = 5, source = "quest", sourceInfo = "Chain: One Adventurous Hatchling — First Step Into Parenthood (89385) — 1 day hatch", canBattle = false, waypoint = LOC.VaelithSunplume, zone = "Eversong Woods", score = T.medium },
    ...
    -- Treasure Pets (found in world treasure objects)
    {
        ...
        pets = {
            { speciesID = 4974, npcID = 246696, name = "Dali",                  petType = 9,  source = "treasure", sourceInfo = "Burbling Paint Pot, Eversong Woods (use in water)",                           canBattle = false, waypoint = LOC.BurblingPaintPot, zone = "Eversong Woods",
              steps = "Loot the Burbling Blob of Paint from the pot beside the easel, then swim out and dive below the surface before using it. Used on dry land it does nothing." },
            { speciesID = 4967, npcID = 256567, name = "Gortham",               petType = 8,  source = "treasure", sourceInfo = "Netherstorm Structural Cage, Nexus-Point Xenas dungeon (5-player puzzle)",    canBattle = true,  zone = "Nexus-Point Xenas", score = T.medium },
            ...
            { speciesID = 4948, npcID = 256059, name = "Perturbed Sporebat",    petType = 3,  source = "treasure", sourceInfo = "Impenetrably Sealed Gourd, Harandar (cave puzzle, 27.5, 68.0)",               canBattle = false, waypoint = LOC.SealedGourd, zone = "Harandar",
              steps = "In the two-level cave south of Har'alnor, take the Mysterious Red Fluid and the Mysterious Purple Fluid from the flasks on the lower level. Carry both up to the Durable Vase mixing station beside the gourd, combine them into Fizzing Fluid, and use that on the seal." },
            { speciesID = 4906, npcID = 253399, name = "Scruffbeak",            petType = 5,  source = "treasure", sourceInfo = "Abandoned Nest, Zul'Aman - 72hr egg hatch (42.6, 52.4)",                     canBattle = false, waypoint = LOC.AbandonedNest, zone = "Zul'Aman", score = T.medium },
            { speciesID = 5003, npcID = 259728, name = "Sunwing Hatchling",     petType = 2,  source = "treasure", sourceInfo = "Rookery Cache, Silvermoon City (key + puzzle, 24.3, 69.3)",                   canBattle = false, waypoint = LOC.RookeryCache, zone = "Silvermoon City",
              steps = "Buy Tasty Meat from Farstrider Aerieminder beside the chest atop the Sunwing Rookery, then place it on the plate in front of the Mischievous Chick. Once the chick eats, it drops the Rookery Cache Key on the ground; loot the key and unlock the cache." },
    ...
    -- Delve Pets (End-of-run Nemesis Strongbox + Nullaeus nemesis drop)
    {
        ...
        pets = {
            ...
            { speciesID = 4959, npcID = 256278, name = "Hexed Bunny",           petType = 8,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4957, npcID = 256282, name = "Lost Star",             petType = 6,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4961, npcID = 256269, name = "Nibblesworth",          petType = 8,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4953, npcID = 256264, name = "Sporbie",               petType = 3,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4956, npcID = 256237, name = "Spormilian",            petType = 7,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4960, npcID = 256238, name = "Treja'saka",            petType = 8,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            { speciesID = 4954, npcID = 256276, name = "Ziorg'pharon",          petType = 7,  source = "delve", sourceInfo = "Delve end-of-run (Nemesis Strongbox)",                            canBattle = false, score = T.medium },
            ...
            { speciesID = 4958, npcID = 256265, name = "Ominous Dominus",       petType = 7,  source = "delve", sourceInfo = "Nullaeus (Season 1 Nemesis boss) - ~7% from Nullaeus Cache",     canBattle = false,
              dropInfo = { mob = "Nullaeus", npcID = 252892, rate = "~7%" }, score = T.epic },
        },
    },
    ...
    -- Trading Post Pets (Trader's Tender, rotates monthly)
    {
        source = "tradingpost",
        pets = {
            { speciesID = 4963, npcID = 256559, name = "Grumpy Mandrake",      petType = 7,  source = "tradingpost", sourceInfo = "Trading Post - Trader's Tender (rotating)",  canBattle = true, score = T.medium },
            { speciesID = 4964, npcID = 256560, name = "Plump Mandrake",       petType = 7,  source = "tradingpost", sourceInfo = "Trading Post - Trader's Tender (rotating)",  canBattle = true, score = T.medium },
            { speciesID = 4966, npcID = 256566, name = "Screechy Mandrake",    petType = 7,  source = "tradingpost", sourceInfo = "Trading Post - Trader's Tender (rotating)",  canBattle = true, score = T.medium },
        },
    },
