...
MC.RegisterContent("vanilla", "pets", {
    { source = "drop", pets = {
        ...
        { speciesID = 232, npcID = 35396, name = "Darting Hatchling", petType = 8, source = "drop", sourceInfo = "|cFFFFD200Drop: |rDart's Nest|n|cFFFFD200Zone: |rDustwallow Marsh", zone = "Dustwallow Marsh" },
        { speciesID = 235, npcID = 35387, name = "Leaping Hatchling", petType = 8, source = "drop", sourceInfo = "|cFFFFD200Drop: |rTakk's Nest|n|cFFFFD200Zone: |rThe Barrens", zone = "Northern Barrens" },
        { speciesID = 237, npcID = 35397, name = "Ravasaur Hatchling", petType = 8, source = "drop", sourceInfo = "|cFFFFD200Drop: |rRavasaur Matriarch's Nest|n|cFFFFD200Zone: |rUn'goro Crater", zone = "Un'Goro Crater" },
    ...
    { source = "quest", pets = {
        { speciesID = 220, npcID = 34278, name = "Withers", petType = 7, source = "quest", sourceInfo = "|cFFFFD200Quest: |rRemembrance of Auberdine|n|cFFFFD200Zone: |rDarkshore", zone = "Darkshore" },
        ...
        { speciesID = 291, npcID = 51090, name = "Singing Sunflower", petType = 7, source = "quest", sourceInfo = "|cFFFFD200Quest:|r Lawn of the Dead|n|cFFFFD200Zone:|r Hillsbrad Foothills|n", zone = "Hillsbrad Foothills" },
        { speciesID = 301, npcID = 52226, name = "Panther Cub", petType = 8, source = "quest", sourceInfo = "|cFFFFD200Quest:|r Some Good Will Come|n|cFFFFD200Zone:|r Northern Stranglethorn|n|n", zone = "Northern Stranglethorn" },
        ...
        { speciesID = 331, npcID = 54539, name = "Alliance Balloon", petType = 3, source = "quest", sourceInfo = "|cFFFFD200Quest:|r Blown Away|n|cFFFFD200Zone:|r Stormwind", zone = "Stormwind City" },
        { speciesID = 332, npcID = 54541, name = "Horde Balloon", petType = 3, source = "quest", sourceInfo = "|cFFFFD200Quest:|r Blown Away|n|cFFFFD200Zone:|r Orgrimmar|n", zone = "Orgrimmar" },
    } },
    { source = "vendor", pets = {
        { speciesID = 629, npcID = 63097, name = "Shore Crawler", petType = 9, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rMatty|n|cFFFFD200Zone: |rOrgrimmar", zone = "Orgrimmar" },
        { speciesID = 630, npcID = 63098, name = "Gilnean Raven", petType = 3, source = "vendor", sourceInfo = "|cFFFFD200Vendor:|r Will Larsons|n|cFFFFD200Zone:|r Darkshore", zone = "Stormwind City" },
...
MC.RegisterContent("wrath", "pets", {
    { source = "achievement", pets = {
        ...
        { speciesID = 202, npcID = 32841, name = "Baby Blizzard Bear", petType = 8, source = "achievement", sourceInfo = "|cFFFFD200Achievement: |rWoW's 4th Anniversary|n|cFFFFD200Category: |rFeats of Strength", zone = "Tanaris", unavailable = true },
        ...
        { speciesID = 243, npcID = 36607, name = "Onyxian Whelpling", petType = 2, source = "achievement", sourceInfo = "|cFFFFD200Achievement: |rWoW's 5th Anniversary|n|cFFFFD200Category: |rFeats of Strength", zone = "Tanaris", unavailable = true },
    ...
    { source = "event", pets = {
        ...
        { speciesID = 225, npcID = 33530, name = "Curious Oracle Hatchling", petType = 1, source = "event", sourceInfo = "|cFFFFD200World Event:|r Children's Week", zone = "Dalaran" },
    ...
    { source = "vendor", pets = {
        { speciesID = 198, npcID = 32595, name = "Pengu", petType = 9, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rSairuk|n|cFFFFD200Zone: |rDragonblight|n|cFFFFD200Faction: |rThe Kalu'ak - Exalted|n|cFFFFD200Cost: |r12|TINTERFACE\\MONEYFRAME\\UI-GOLDICON.BLP:0|t|n|n|cFFFFD200Vendor: |rTanaika|n|cFFFFD200Zone: |rHowling Fjord|n|cFFFFD200Faction: |rThe Kalu'ak - Exalted|n|cFFFFD200Cost: |r12|TINTERFACE\\MONEYFRAME\\UI-GOLDICON.BLP:0|t", zone = "Dragonblight" },
        { speciesID = 236, npcID = 35399, name = "Obsidian Hatchling", petType = 8, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rBreanni|n|cFFFFD200Zone: |rCrystalsong Forest|n|cFFFFD200Cost: |r50|TINTERFACE\\MONEYFRAME\\UI-GOLDICON.BLP:0|t", zone = "Dalaran" },
...
MC.RegisterContent("cata", "pets", {
    ...
    { source = "event", pets = {
        ...
        { speciesID = 341, npcID = 55571, name = "Lunar Lantern", petType = 6, source = "event", sourceInfo = "|cFFFFD200World Event:|r Lunar Festival|n|cFFFFD200Vendor: |rValadar Starsong|n|cFFFFD200Zone: |rMoonglade|n|cFFFFD200Cost: |r50|TINTERFACE\\ICONS\\INV_Misc_ElvenCoins:0|t", zone = "Moonglade" },
        { speciesID = 342, npcID = 55574, name = "Festival Lantern", petType = 6, source = "event", sourceInfo = "|cFFFFD200World Event:|r Lunar Festival|n|cFFFFD200Vendor: |rValadar Starsong|n|cFFFFD200Zone: |rMoonglade|n|cFFFFD200Cost: |r50|TINTERFACE\\ICONS\\INV_Misc_ElvenCoins:0|t", zone = "Moonglade" },
    } },
    { source = "profession", pets = {
    ...
    { source = "vendor", pets = {
        ...
        { speciesID = 318, npcID = 53661, name = "Crimson Lasher", petType = 7, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rAyla Shadowstorm|n|cFFFFD200Zone: |rMolten Front|n|cFFFFD200Cost: |r1500|TINTERFACE\\MONEYFRAME\\UI-GOLDICON.BLP:0|t", zone = "Molten Front" },
        ...
        { speciesID = 330, npcID = 54491, name = "Darkmoon Monkey", petType = 8, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t |n", zone = "Darkmoon Island" },
        { speciesID = 335, npcID = 54487, name = "Darkmoon Turtle", petType = 9, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t ", zone = "Darkmoon Island" },
        { speciesID = 336, npcID = 55187, name = "Darkmoon Balloon", petType = 3, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t |n", zone = "Darkmoon Island" },
        { speciesID = 338, npcID = 55356, name = "Darkmoon Tonk", petType = 10, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t ", zone = "Darkmoon Island" },
        { speciesID = 339, npcID = 55367, name = "Darkmoon Zeppelin", petType = 10, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t ", zone = "Darkmoon Island" },
        { speciesID = 343, npcID = 56031, name = "Darkmoon Cub", petType = 8, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t |n", zone = "Darkmoon Island" },
        ...
        { speciesID = 4508, npcID = 222593, name = "Emerald Sporbit", petType = 6, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rMaterialist Ophinell|n|cFFFFD200Zone: |rTwilight Highlands|n|cFFFFD200Cost: |r30|Hcurrency:3319|h|TInterface\\ICONS\\INV12_Twilight_ Blade_Cultist_Insignia.BLP:0|t|h", zone = "Twilight Highlands" },
    } },
})
...
MC.RegisterContent("mop", "pets", {
    ...
    { source = "drop", pets = {
        ...
        { speciesID = 848, npcID = 59358, name = "Darkmoon Rabbit", petType = 5, source = "drop", sourceInfo = "|cFFFFD200Drop: |rDarkmoon Rabbit|n|cFFFFD200Zone: |rDarkmoon Island", zone = "Darkmoon Island" },
        { speciesID = 1063, npcID = 67332, name = "Darkmoon Eye", petType = 6, source = "drop", sourceInfo = "|cFFFFD200Drop:|r Darkmoon Pet Supplies|n" },
        { speciesID = 1276, npcID = 72160, name = "Moon Moon", petType = 8, source = "drop", sourceInfo = "|cFFFFD200Drop: |rMoonfang|n|cFFFFD200Zone: |rDarkmoon Island", zone = "Darkmoon Island" },
        { speciesID = 1320, npcID = 73011, name = "Lil' Bling", petType = 10, source = "drop", sourceInfo = "|cFFFFD200Drop:|r Blingtron Gift Package|n" },
        { speciesID = 1322, npcID = 73352, name = "Blackfuse Bombling", petType = 10, source = "drop", sourceInfo = "|cFFFFD200Drop:|r Siegecrafter Blackfuse|n|cFFFFD200Raid:|r Siege of Orgrimmar", zone = "Vale of Eternal Blossoms" },
        { speciesID = 1331, npcID = 73350, name = "Droplet of Y'Shaarj", petType = 7, source = "drop", sourceInfo = "|cFFFFD200Drop:|r Sha of Pride|n|cFFFFD200Raid:|r Siege of Orgrimmar|n|cFFFFD200Difficulty:|r Flexible, Normal or Heroic", zone = "Vale of Eternal Blossoms" },
    } },
    { source = "event", pets = {
    ...
    { source = "vendor", pets = {
        { speciesID = 1061, npcID = 67319, name = "Darkmoon Hatchling", petType = 5, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rLhara|n|cFFFFD200Zone: |rDarkmoon Island|n|cFFFFD200Cost: |r90|TINTERFACE\\ICONS\\inv_misc_ticket_darkmoon_01:0|t", zone = "Darkmoon Island" },
        ...
        { speciesID = 1303, npcID = 72462, name = "Chi-Chi, Hatchling of Chi-Ji", petType = 3, source = "vendor", sourceInfo = "|cFFFFD200Vendor: |rMaster Li|n|cFFFFD200Zone: |rTimeless Isle|n|cFFFFD200Cost: |r3|TINTERFACE\\ICONS\\INV_MISC_TRINKETPANDA_07:0|t", zone = "Timeless Isle" },
    } },
    { source = "wild", pets = {
...
MC.RegisterContent("legion", "pets", {
    ...
    { source = "drop", pets = {
        { speciesID = 382, npcID = 61087, name = "Sun Darter Hatchling", petType = 2, source = "drop", sourceInfo = "|cFFFFD200Drop:|r Oddly-Colored Egg|n", zone = "Winterspring" },
    } },
})
