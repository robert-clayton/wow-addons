...
MC.JewelcraftingRecipes = {
    ...
    },
    {
        name = "PvP Gems",
        recipes = {
            { id = 1230500, name = "Determined Heliotrope", source = "vendor", sourceInfo = "Mirvedon (7500 Honor)", priority = 1, waypoint = LOC.Mirvedon, cost = { currency = { MC.CURRENCY.Honor, 7500 } } },
            { id = 1230501, name = "Cognitive Heliotrope",  source = "vendor", sourceInfo = "Mirvedon (7500 Honor)", priority = 1, waypoint = LOC.Mirvedon, cost = { currency = { MC.CURRENCY.Honor, 7500 } } },
            { id = 1230502, name = "Enduring Heliotrope",   source = "vendor", sourceInfo = "Mirvedon (7500 Honor)", priority = 1, waypoint = LOC.Mirvedon, cost = { currency = { MC.CURRENCY.Honor, 7500 } } },
        },
    },
    {
        name = "Rings",
        recipes = {
            ...
            { id = 1230479, name = "Loa Worshiper's Band",           source = "vendor",         sourceInfo = "Magovu (1500 Voidlight Marl + 150 Moxie)", priority = 1, waypoint = LOC.Magovu, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 }, currency2 = { MC.CURRENCY.VoidlightMarl, 1500 } } },
            { id = 1230487, name = "Signet of Azerothian Blessings", source = "vendor",         sourceInfo = "Naynar (150 Moxie)",                       priority = 1, waypoint = LOC.Naynar, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 }, currency2 = { MC.CURRENCY.VoidlightMarl, 1500 } } },
            { id = 1230503, name = "Thalassian Competitor's Signet", source = "vendor",         sourceInfo = "Mirvedon (7500 Honor)",                    priority = 1, waypoint = LOC.Mirvedon, cost = { currency = { MC.CURRENCY.Honor, 7500 } } },
    ...
    },
    {
        ...
        recipes = {
            ...
            { id = 1230504, name = "Thalassian Competitor's Amulet",   source = "vendor",         sourceInfo = "Mirvedon (7500 Honor)",                     priority = 1, waypoint = LOC.Mirvedon, cost = { currency = { MC.CURRENCY.Honor, 7500 } } },
            ...
            { id = 1230488, name = "Thalassian Phoenix Torque",        source = "drop",           sourceInfo = "Belo'ren",                                  priority = 4 },
            { id = 1251983, name = "Voidstone Shielding Array",        source = "drop",           sourceInfo = "Charonus",                                   priority = 4 },
        },
    },
    {
        name = "Reagents",
    ...
    },
    {
        ...
        recipes = {
            ...
            { id = 1230496, name = "Sin'dorei Jeweler's Loupes",                 source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1230495, name = "Sin'dorei Enchanter's Crystal",              source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1230497, name = "Improved Right-Handed Magnifying Glass",     source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1230498, name = "Sin'dorei Scribe's Spectacles",             source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1242461, name = "Mage-Eye Precision Loupes",                  source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1242462, name = "Thalassian Scribe's Crystalline Lens",       source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1242463, name = "Flawless Text Scrutinizers",                 source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
            { id = 1242464, name = "Attuned Thalassian Rune-Prism",              source = "vendor",  sourceInfo = "Lyrendal (150 Artisan Moxie)",  priority = 1, waypoint = LOC.Lyrendal, cost = { currency = { MC.CURRENCY.JewelcraftingMoxie, 150 } } },
        },
    },
    {
        name = "Miscellaneous",
