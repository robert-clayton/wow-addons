...
MC.RegisterContent("midnight", "decorations", {
    ...
    -- Achievement — Exploration, Profession Signs, Questing
    {
        ...
        decorations = {
            ...
            { decorID = 10542, name = "\"Eversong Lantern\" Painting", source = "achievement", sourceInfo = "Eversong Woods: The Highest Peaks", zone = "Eversong Woods", achievementID = 62288, score = T.short },
            { decorID = 11325, name = "Amani Spearhunter's Spit", source = "achievement", sourceInfo = "Zul'Aman: The Highest Peaks", zone = "Zul'Aman", achievementID = 62289, score = T.short },
            ...
            { decorID = 15890, name = "Void Elf Weapon Rack", source = "achievement", sourceInfo = "Voidstorm: The Highest Peaks", zone = "Voidstorm", achievementID = 62291, score = T.short },
            -- Exploration: Other
            { decorID = 11470, name = "Silvermoon Energy Focus", source = "achievement", sourceInfo = "A Bloody Song", zone = "Eversong Woods", achievementID = 61507 },
            { decorID = 15573, name = "Colossal Amani Stone Visage", source = "achievement", sourceInfo = "Tallest Tree in the Forest", zone = "Zul'Aman", achievementID = 62122, taskList = TALLEST_TREE_TASKS, score = T.short },
            { decorID = 15501, name = "Lightbloom Moss Mound", source = "achievement", sourceInfo = "Leaf None Behind", achievementID = 61264 },
            { decorID = 15757, name = "Opened Domanaar Storage Crate", source = "achievement", sourceInfo = "The Ultimate Predator", zone = "Voidstorm", achievementID = 62130, taskList = ULTIMATE_PREDATOR_TASKS, score = T.short },
            ...
            -- Zone Events
            { decorID = 8872, name = "Eversong Feast Platter", source = "achievement", sourceInfo = "The Party Must Go On", zone = "Eversong Woods", achievementID = 62186 },
            { decorID = 8874, name = "Eversong Dessert Platter", source = "achievement", sourceInfo = "The Party Must Go On", zone = "Eversong Woods", achievementID = 62186 },
            -- Profession Shop Signs
            { decorID = 15402, name = "Midnight Alchemist's Shop Sign", source = "achievement", sourceInfo = "Alchemizing at Midnight", zone = "Silvermoon City", achievementID = 42788 },
            { decorID = 15403, name = "Midnight Blacksmith's Shop Sign", source = "achievement", sourceInfo = "Blacksmithing at Midnight", zone = "Silvermoon City", achievementID = 42792 },
            { decorID = 15404, name = "Midnight Cook's Shop Sign", source = "achievement", sourceInfo = "Cooking at Midnight", zone = "Silvermoon City", achievementID = 42795 },
            { decorID = 15405, name = "Midnight Enchanter's Shop Sign", source = "achievement", sourceInfo = "Enchanting at Midnight", zone = "Silvermoon City", achievementID = 42787 },
            { decorID = 15406, name = "Midnight Engineer's Shop Sign", source = "achievement", sourceInfo = "Engineering at Midnight", zone = "Silvermoon City", achievementID = 42798 },
            { decorID = 15407, name = "Midnight Fisher's Shop Sign", source = "achievement", sourceInfo = "Fishing at Midnight", achievementID = 42797 },
            { decorID = 15408, name = "Midnight Herbalist's Shop Sign", source = "achievement", sourceInfo = "Herbalism at Midnight", zone = "Silvermoon City", achievementID = 42793 },
            { decorID = 15410, name = "Midnight Jewelcrafter's Shop Sign", source = "achievement", sourceInfo = "Jewelcrafting at Midnight", zone = "Silvermoon City", achievementID = 42789 },
            { decorID = 15411, name = "Midnight Leatherworker's Shop Sign", source = "achievement", sourceInfo = "Leatherworking at Midnight", zone = "Silvermoon City", achievementID = 42786 },
            { decorID = 15457, name = "Midnight Miner's Shop Sign", source = "achievement", sourceInfo = "Mining at Midnight", achievementID = 42791 },
            { decorID = 15409, name = "Midnight Scribe's Shop Sign", source = "achievement", sourceInfo = "Inscribing at Midnight", zone = "Silvermoon City", achievementID = 42796 },
            { decorID = 15458, name = "Midnight Skinner's Shop Sign", source = "achievement", sourceInfo = "Skinning at Midnight", zone = "Silvermoon City", achievementID = 42790 },
            { decorID = 15459, name = "Midnight Tailor's Shop Sign", source = "achievement", sourceInfo = "Tailoring at Midnight", zone = "Silvermoon City", achievementID = 42794 },
            -- Feat of Strength
