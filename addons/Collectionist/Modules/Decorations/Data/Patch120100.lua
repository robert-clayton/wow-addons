...
MC.RegisterContent("midnight", "decorations", {
    ...
    -- Community Coupon vendors: Westfall collection and Amani Endeavor.
    {
        ...
        decorations = {
            ...
            { decorID = 15265, itemID = 263708, name = "Amani Anvil", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
            { decorID = 22920, itemID = 274527, name = "Amani Building Peg", source = "vendor", sourceInfo = "Amani Endeavor - 2 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 2 } } },
            { decorID = 22916, itemID = 274518, name = "Amani Decorative Plinth", source = "vendor", sourceInfo = "Amani Endeavor - 20 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 20 } } },
            { decorID = 22917, itemID = 274521, name = "Amani Road Marker", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
            { decorID = 10859, itemID = 255649, name = "Amani Water Well", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
            { decorID = 15157, itemID = 263317, name = "Amani Wicker Crate", source = "vendor", sourceInfo = "Amani Endeavor - 10 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 10 } } },
            { decorID = 22921, itemID = 274529, name = "Forest Troll Fence", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
            { decorID = 22922, itemID = 274531, name = "Forest Troll Fencepost", source = "vendor", sourceInfo = "Amani Endeavor - 10 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 10 } } },
            { decorID = 22927, itemID = 274505, name = "Shrine of Akil'zon, Loa of Victory", source = "vendor", sourceInfo = "Amani Endeavor - 30 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 30 } } },
            { decorID = 23188, itemID = 274539, name = "Shrine of Halazzi, Loa of the Hunt", source = "vendor", sourceInfo = "Amani Endeavor - 30 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 30 } } },
            { decorID = 22926, itemID = 274537, name = "Shrine of Jan'alai, Loa of Fire", source = "vendor", sourceInfo = "Amani Endeavor - 30 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 30 } } },
            { decorID = 22925, itemID = 274535, name = "Shrine of Nalorakk, Loa of War", source = "vendor", sourceInfo = "Amani Endeavor - 30 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 30 } } },
            { decorID = 22919, itemID = 274525, name = "Steamy Romance Tablet", source = "vendor", sourceInfo = "Amani Endeavor - 10 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 10 } } },
            { decorID = 22924, itemID = 274533, name = "Witch Doctor's Punch Bowl", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
            { decorID = 22918, itemID = 274523, name = "Woven Forest Troll Rug", source = "vendor", sourceInfo = "Amani Endeavor - 15 Community Coupons", zone = "Housing Neighborhood", cost = { currency = { MC.CURRENCY.CommunityCoupons, 15 } } },
        },
    },
    ...
    -- Weekly Cursed Keepsake housing quest.
    {
        source = "quest",
        decorations = {
            { decorID = 18960, itemID = 267435, name = "Purified Kaldorei Candle", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 20332, itemID = 268943, name = "Purified Elven Glowlamp", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 18796, itemID = 267205, name = "Purified Folk Candle", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 15286, itemID = 263876, name = "Purified Folk Mirror", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 18880, itemID = 267355, name = "Purified Elven Mirror", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 21873, itemID = 272129, name = "Purified Tauren Pot", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
            { decorID = 11285, itemID = 256684, name = "Purified Troll Amulet", source = "quest", sourceInfo = "Cursed Keepsake weekly quest (Patch 12.1)", zone = "Housing Neighborhood" },
        },
    },
