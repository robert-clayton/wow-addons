...
MC.RareSourceOrder = {
    "eversong", "zulaman", "harandar", "voidstorm", "val", "naigtal",
    "eversong_woods", "isle_of_queldanas", "coiled_isle", "azj_kahet",
    ...
    "zereth_mortis", "arathi_highlands", "darkshore", "drustvar", "mechagon",
    "nazjatar", "nazmir", "stormsong_valley", "tiragarde_sound", "uldum",
    "vale_of_eternal_blossoms", "voldun", "zuldazar", "argus", "azsuna",
    "broken_shore", "eredath", "highmountain", "stormheim", "suramar",
    "valsharah", "frostfire_ridge", "gorgrond", "nagrand_draenor",
    "shadowmoon_valley_draenor", "spires_of_arak", "talador",
    "tanaan_jungle", "dread_wastes", "isle_of_giants", "isle_of_thunder",
    "krasarang_wilds", "kun_lai_summit", "pandaria", "jade_forest",
    "veiled_stair", "timeless_isle", "townlong_steppes",
    "valley_of_the_four_winds", "northrend", "outland"
}
MC.RareSourceLabels = {
