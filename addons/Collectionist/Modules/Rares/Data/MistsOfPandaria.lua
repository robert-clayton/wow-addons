...
MC.RegisterContent("mop", "rares", {
    ...
    { source = "krasarang_wilds", achievementID = 7932, criteriaCount = 6,
      ...
      zoneMapID = MC.MAP.KrasarangWilds, zone = "Krasarang Wilds" },
    { source = "isle_of_thunder", achievementID = 8103, criteriaCount = 10,
    ...
    { source = "timeless_isle", achievementID = 8714, criteriaCount = 32,
